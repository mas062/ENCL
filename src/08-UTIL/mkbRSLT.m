function [] = mkbRSLT(caseName)
%MKBRSLT Make backup RSLT folder
%   mkbRSLT(caseName) makes the RSLT folder which is to contain result
%   information of the run which is specific to case caseName.
%   
%   See also mkbSCN, mkCMD, mkSINC.
