function [] = rmRst(caseName,varargin)
%RMRST Remove Restart
%   rmRst(caseName,varargin) cleans up the run directory  from restart
%   files (which are bigger in size compared to other outputs) and filters 
...
%
indRst = [pthSCN(caseName) caseName '.FRSSPEC'];
